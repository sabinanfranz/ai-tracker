...
updates = [
    ...
    ("37529b61-25a9-460c-be88-b58cd6d233a8",
     "Personalization: Sunsetting the Nerdy base style preset",
     "OpenAI is removing the preset Nerdy base style from ChatGPT to simplify response personality options and improve quality.\nUsers who previously selected the Nerdy style will be automatically moved to the default personality setting.\nPersonality preferences remain fully customizable under Settings then Personalization for all users."),
    ("eadba11d-04d2-485e-a668-35518750c9c9",
     "Model Picker: Simplified tier-based model selection with Auto routing",
     "ChatGPT's model picker is simplified into Instant, Thinking, and Pro tiers for Plus, Pro, Business, Enterprise, and Edu users.\nAuto-switch to Thinking is available via Configure in the picker menu, upgrading responses when complexity warrants deeper reasoning.\nFree and Go users see a streamlined picker with fewer options while retaining access to core capabilities."),
    ("0893f89f-64f1-4784-be43-5603cab71569",
     "GPT-5.4 mini: Fast reasoning model rolls out across ChatGPT tiers",
     "GPT-5.4 mini is rolling out in ChatGPT, available to Free and Go users via the Thinking feature in the + menu.\nFor Plus, Pro, and paid users, GPT-5.4 mini serves as a rate-limit fallback for GPT-5.4 Thinking during high usage periods.\nEnterprise customers retain the option to default Auto routing to GPT-5.4 mini or restrict it via admin controls."),
    ("b01a2fc0-d120-4552-adcd-d70fc608fc22",
     "Deprecation: Legacy deep research mode removal scheduled March 26",
     "The legacy deep research mode will be removed on March 26, 2026; the current deep research experience remains unchanged.\nHistorical conversations and results from the legacy mode will stay accessible after the deprecation date.\nThis cleanup only affects the older deep research mode, consolidating around the improved current implementation."),
    ("4309b588-e401-4f5e-b432-a700b4fc20cb",
     "Codex for Students: $100 credits for verified US & Canada university students",
     "Codex for Students offers verified university students in the US and Canada $100 in ChatGPT credits (2,500 credits) to extend Codex usage.\nStudents sign in at chatgpt.com/codex/students, verify through SheerID with their university email, and credits apply automatically.\nCredits work in Codex across Free, Go, Plus, and Pro plans and are not transferable between workspaces."),
    ("f3900bca-7fdc-41c2-929a-b60508f81381",
     "File Library: Centralized file management with cross-chat reuse",
     "ChatGPT now automatically saves uploaded and created files including PDFs, spreadsheets, images, and more to a new Library tab in the sidebar.\nUsers can quickly reference saved files in the composer via recent files, or browse everything in the Library for cross-chat reuse.\nGenerated images continue to appear in the Images tab while all other file types are organized in the Library."),
    ("26e30775-95f8-4b14-aed7-1f0d20a567eb",
     "Shopping: Richer product results with visual comparison & image search",
     "Product results in ChatGPT are now more visually rich with improved detail and relevance for shopping queries.\nUsers can browse products in chat, refine results through conversation, and upload images to find similar items.\nSide-by-side product comparison now shows key details like price, reviews, and features for easier decision-making."),
    ("b28f4265-b03d-4e73-aeb3-bd179abab5cd",
     "Google Drive: Unified app replaces separate Docs, Sheets & Slides connectors",
     "Google's file connectors in ChatGPT are now unified under a single Google Drive app for Docs, Sheets, and Slides.\nNew users connect once to Google Drive instead of installing separate apps; existing users are migrated automatically.\nThe unified experience removes redundant authentication steps while maintaining full functionality across all Google file types."),
    ("e8fc5092-a4d1-4101-b641-ad3ae85e4659",
     "Composer: Large pastes auto-converted to attachments for Plus, Pro & Business",
     "Pasting more than 5,000 characters into the composer now automatically converts the content into an attachment instead of inline text.\nThis keeps the composer cleaner and prevents large pastes from consuming the entire context window.\nAvailable for ChatGPT Plus, Pro, and Business users, with the option to move content back to inline text."),
    ("b932b6a5-217b-4482-923a-518c670f1ef8",
     "Codex Plugins: Curated directory for packaged workflow bundles",
     "Codex now includes a curated plugins directory for discovering, installing, and using packaged workflows built from apps and skills.\nPlugins bundle skills, optional app integrations, and MCP server configurations in a single installable package for team sharing.\nThis makes it easier to share the same setup across projects or teams with consistent reusable workflows."),
    ("5f99a4fe-ec21-4591-b349-b4ff2b682280",
     "Location Sharing: Optional device location for local recommendations",
     "Users can now opt in to share their device location so ChatGPT can provide locally relevant information like recommendations, news, and weather.\nLocation sharing is off by default and can be enabled or disabled at any time in Settings > Data Controls.\nEnabling location sharing also activates precise location for more accurate geographic context."),
    ("79592a1c-f2c7-4965-8e64-97f7886271f8",
     "Mobile UI: Simplified sidebar with horizontal feature bar",
     "The sidebar menu on iOS and Android has been simplified to give more space for viewing critical chats and projects.\nChatGPT experiences like Images, Codex, Pulse, and Apps now appear in a horizontal bar above chats and projects.\nAvailable features in the bar are based on the user's plan and usage tier."),
    ("b39a2e89-a967-4e85-a94f-acfc2fe97510",
     "Connected Apps: Updated Box, Notion, Linear & Dropbox integrations",
     "Box, Notion, Linear, and Dropbox apps in ChatGPT have been updated with new actions including write capabilities where supported.\nExisting users need to reconnect these apps to access the updated experience; existing sync functionality for Pro users is unaffected.\nThe updates bring the latest app experience into ChatGPT for richer cross-platform workflows."),
    # --- batch added 2026-04-26 ---
    ("0192143b-d721-4d77-b76e-a7ae69278604",
     "ChatGPT in CarPlay: Hands-free voice access while driving on iOS 26.4+",
     "ChatGPT rolls out in Apple CarPlay, giving users hands-free access through their car's CarPlay interface for voice conversations on the go.\nRequires iOS 26.4 or newer and a supported car connection; users can start new voice conversations from CarPlay and resume existing voice mode conversations from the ChatGPT mobile app.\nThis brings ChatGPT into the in-vehicle experience for the first time, complementing the broader voice mode rollout and positioning ChatGPT alongside Siri and Google Assistant for hands-free assistance during driving."),
    ("cfa785c7-329a-4f5a-b727-972371dbaf25",
     "Outlook Apps: Add support for shared mailboxes & delegated calendars in ChatGPT",
     "The Outlook Email and Calendar apps for ChatGPT now help with delegated or shared Outlook resources, letting ChatGPT read, send, and manage mail or events on behalf of those mailboxes.\nShared mailbox support covers reading messages, browsing folders, marking read/unread, moving messages, and sending plain-text mail; shared calendars allow create, update, RSVP, cancel, delete, and add small attachments.\nUsers must connect the Outlook Email or Calendar app and provide the exact shared mailbox address or calendar; availability depends on Microsoft permissions and workspace app settings, expanding ChatGPT's enterprise productivity reach."),
    ("34ffdc7c-c709-4a30-9e04-341f006a3d37",
     "Pro Plans: New $100/month tier with up to 10x Codex usage of Plus",
     "OpenAI introduces a new $100/month Pro plan and updates how Codex usage works across Plus and Pro tiers, balancing high-intensity sessions with steady daily use.\nPro $100/mo includes unlimited GPT-5.4, GPT-5.4 Pro access, and up to 10x Codex usage of Plus (up from 5x); Pro $200/mo continues current Codex promotion through May 31; Plus $20/mo rebalances Codex for steady weekly sessions.\nThis restructures the Pro tier to capture users who want intense Codex sessions without the $200 premium, while ending the temporary Codex promotion on Plus to spread usage across the week rather than single high-intensity days."),
    ("88b798d4-6cf1-49cd-a20d-5c5ca4458f39",
     "GPT-5.3 Instant Mini: Fallback model after GPT-5.3 Instant rate limits",
     "OpenAI releases GPT-5.3 Instant Mini in ChatGPT, replacing GPT-5 Instant Mini as the fallback model users reach after hitting their GPT-5.3 Instant rate limits.\nGPT-5.3 Instant Mini won't appear in the model picker because it serves as a fallback only; it outperforms GPT-5 Instant Mini with more natural conversation, stronger writing, and better contextual awareness.\nThis refreshes the rate-limit fallback layer to match the GPT-5.3 series, ensuring users hitting limits get a more capable mini model rather than dropping back to the older GPT-5 generation."),
    ("09e2fab6-f1be-47ba-ad76-bc2ed660e105",
     "Ads: Rollout begins for Free & Go plans in Australia, New Zealand & Canada",
     "ChatGPT begins rolling out ads to users on Free and Go plans in Australia, New Zealand, and Canada as part of a phased monetization expansion.\nPlus, Pro, Business, Enterprise, and Education plans do not include ads; the rollout is limited to the three named markets at this stage with no announced timeline for expansion.\nThis continues OpenAI's push to monetize free-tier ChatGPT usage in non-U.S. markets, preserving an ad-free experience as a paid-plan benefit and signaling further geographic ad rollouts to come."),
    ("533d0217-fec7-4596-81fa-164af9294a85",
     "ChatGPT Images 2.0: New image generation model with images-with-thinking on paid plans",
     "OpenAI introduces ChatGPT Images 2.0, a new image generation model in ChatGPT, alongside images with thinking that plans and refines outputs before generating them.\nChatGPT Images 2.0 is available on all ChatGPT plans; images with thinking is available on all paid plans when Thinking and Pro models are selected from the model picker.\nThis succeeds the original 4o Image Generation, layering deliberate planning into image generation for higher-quality outputs on paid tiers while keeping the base model accessible to free users."),
    ("eabddb74-bffd-4a33-a931-7fae96d57437",
     "ChatGPT for Clinicians: Free workspace for verified U.S. clinicians with CME credits",
     "OpenAI launches ChatGPT for Clinicians, a free version of ChatGPT for verified clinicians in the United States designed to support real clinical work at the time of care.\nIncludes evidence review, documentation, medical research, trusted clinical search with citations, reusable skills, deep research across medical literature, and CME credit support for eligible clinical questions.\nExisting ChatGPT users can sign up with their same account; ChatGPT for Clinicians appears as a separate workspace under the same login while the existing workspace remains available, marking OpenAI's first vertical-specific ChatGPT product for medical professionals."),
    ("71838791-fe08-4360-876d-4198961c4f22",
     "Fast answers: Quicker responses for common information-seeking questions",
     "ChatGPT rolls out Fast answers, a quicker way to get responses to common information-seeking questions when no personalization is required and ChatGPT has a high-confidence answer ready.\nAvailable globally on web, iOS, and Android for logged-in and logged-out users across all plans; Fast answers do not reference past chats or memory and can be turned off in Personalization settings.\nThis trades personalization for speed on factual lookups like the Seven Wonders or Super Bowl champions, with planned expansion to more question types over time as a complement to standard personalized responses."),
    ("4f6ad76b-1498-4655-9e77-a6ec157f9a5a",
     "GPT-5.5 in ChatGPT: Smartest frontier model for professional work & agentic coding",
     "OpenAI rolls out GPT-5.5 in ChatGPT as the smartest frontier model for professional work, with stronger goal understanding, tool use, and self-checking to carry tasks through to completion.\nGPT-5.5 improves on agentic coding (terminal workflows, GitHub issue resolution, long-horizon tasks), professional knowledge work, and document-grounded retrieval; GPT-5.5 Thinking is on eligible paid plans, GPT-5.5 Pro on Pro/Business/Enterprise/Edu.\nThis is a major step forward from GPT-5, expanding ChatGPT's ability to handle messy multi-step requests across coding, research, analysis, and document creation with stronger reasoning and higher-confidence outputs."),
]
